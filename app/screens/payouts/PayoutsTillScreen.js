...
const PayoutsTillScreen = ({ route, navigation }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values, { resetForm }) => {
      ...
      const data = {
        action: "VehicleCollectionToTill",
        vehicle_registration: vehicle.title,
        amount: formik.values.amount,
        till_number: formik.values.till_number,
        narrative: formik.values.narrative,
      };
      ...
      <View>
        ...
        <View className="mt-2">
          <FloatingLabelInput
            ...
            onChangeText={(value) => formik.setFieldValue("till_number", value)}
            value={formik.values.till_number}
            inputMode="text"
          />
          <ErrorMessage
            error={formik.errors.till_number}
            visible={formik.touched.till_number}
          />
        </View>
...
export default PayoutsTillScreen;
